...
class Map {
    constructor(options) {
        ...
        this.tileMap = new TileMap(this.mapData.mapProperties.tilePaths.ground, this.tileSize, new Vect2(this.w, this.h));
        //this.w = this.tileMap.tileSize * this.tileMap.grid[0].length; //7200
        //this.h = this.tileMap.tileSize * this.tileMap.grid.length; //4800
        this.nodes = [];
    ...
    loadMap() {
        for (let i = 0; i < this.mapData.blocks.length; i++) {
            ...
            let images = {
                imgFile: block.tileOverride.top == "" ? tiles.block.top : block.tileOverride.top,
                imgFileSide: block.tileOverride.side == "" ? tiles.block.side : block.tileOverride.side
            }
